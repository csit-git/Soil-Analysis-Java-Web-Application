                              ...
                              <td><div style="width:933px">
                                  <table class="BasicTable" cellspacing="0" border="0" >
                                    <tbody>
                                      ...
                                      <tr>
                                        <td colspan="2" class="WelcomeNoteSubTitle" align="left"><b>Farmers Buddy:Forum  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </b></td>
                                      ...
                                      <tr>
                                        <td colspan="2" class="BasicFont" align="left"><img src="Sample_files/New Folder/forum.jpg" alt="forum" width="113" height="91" /></td>
                                  <td width="513" align="left" bgcolor="f8f8fa"  class="BlueMsgWriting"><p>Discussion forum of Famers Buddy lets you interact with the general public as well as the agricultural officers through the offline discussions. The users can post their queries and view responses on their post by this section.</p>
                                    <p>Interact and learn.!</p></td>
...
&nbsp;<a><img src="./Sample_files/SearchGoButton.gif" alt="Search" border="0" /></a> </td>
                                      </tr>
                                      <tr>
                                        <td colspan="4" height="15" align="left" class="SmallFont">&nbsp;</td>
                                      </tr>
                                      <tr valign="top">
                                        <td width="201" height="370" valign="top"><table width="100&percnt;" cellpadding="0" cellspacing="0" border="0">
                                            <tbody>
                                              <tr valign="top">
                                        ...
                                        <td width="1">&nbsp;</td>
                                        <td colspan="2" align="left" valign="top"><table width="723" height="401" border="1" cellpadding="0" cellspacing="0">
                                          <tr>
                                          <% 
try{
...
ResultSet rs1=s1.executeQuery("Select qid,username,ques,date from gari.forum");
%>

                                            <td valign="top" align="center"><table width="721" border="0" cellspacing="0" cellpadding="0">
                                              <tr>
                                                <td height="32" bgcolor="#00CCFF"><font color="#FFFFFF" face="Arial, Helvetica, sans-serif" size="+1"><b>Discussion Forum<br /></b></font></td>
                                              </tr>
                                              <tr>
                                                <td><a href="forum.jsp" class="BlueBoldUnderlinedBasicFont style2" onClick="f()"><b>Create a Query</b></a></td>
                                              </tr>
                                              <tr>
                                                <td>&nbsp;</td>
                                              </tr>
...
while(rs1.next())
{
String qid=rs1.getString(1);
%><script type="text/javascript" language="javascript">
function f()
{
 var r;
 r=open('createquery.html','windowmethod','width=800,height=440,toolbar=yes,scrollbars=1,left=200,top=100')
}
 
/*function f1()
{
 var s;
 s=open('ans.jsp?val=1&qid=<%=qid%>','windowmethod','width=350,height=400,toolbar=yes,scrollbars=1,left=200,top=100')
}

function f2()
{
 var t;
 t=open('ans.jsp?val=2&qid=<%=qid%>','windowmethod','width=350,height=400,toolbar=yes,scrollbars=1,left=200,top=100')
}*/
</script>
                                              ...
                                              <tr>
                                                <td align="center"><table width="715" border="0" cellspacing="0" cellpadding="0">
                                                  <tr>
                                                    ...
                                                    <td width="620"><%= rs1.getString(2) %></td>
                                                  </tr>
                                                  <tr>
                                                  ...
                                                  <tr>
                                                    <td colspan="2"><a  class="BlueBoldUnderlinedBasicFont" onClick="open('ans.jsp?val=1&qid=<%=qid%>','windowmethod','width=350,height=400,toolbar=yes,scrollbars=1,left=200,top=100')" >View Response</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="BlueBoldUnderlinedBasicFont">&nbsp;<a onClick="open('ans.jsp?val=2&qid=<%=qid%>','windowmethod','width=350,height=400,toolbar=yes,scrollbars=1,left=200,top=100')" >Send Response</a>&nbsp;&nbsp;</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                                    </tr>
                                                  <tr>
                                                    <td colspan="2"><hr /></td>
                                                  </tr>
