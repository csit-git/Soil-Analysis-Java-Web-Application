                              ...
                              <td><div style="width:933px">
                                  <table class="BasicTable" cellspacing="0" border="0" >
                                    <tbody>
                                      ...
                                      <tr>
                                        <td colspan="2" class="WelcomeNoteSubTitle" align="left"><b>Farmers Buddy:&nbsp;Poll List&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </b></td>
                                      ...
                                      <tr>
                                        ...
                                        <td width="566" align="left"  class="BasicFont">&nbsp;</td>
                                      <td width="155" align="right"  class="BasicFont"> Search: <br />
                                      ...
                                      <tr valign="top">
                                        ...
                                        <td width="1">&nbsp;</td>
                                        <td colspan="2" align="left" valign="top"><table width="721" height="451" border="1" align="center">
                                          <tr>
                                            <td align="center" valign="top"><table width="716" border="1">
                                              <tr>
                                                <td height="39" colspan="2" bgcolor="#007FFF"  align="center"><font color="#FFFFFF" size="+2"><b>Poll List</b></font></td>
                                              </tr>
...
try{
	  ...
	  ResultSet rs=s.executeQuery("select pid,ques,date from shekhar.poll");%>
                                              ...
                                              <tr>
                                                <td width="349" bgcolor="#007FFF" align="center"><font color="#FFFFFF" size="+1"><b>Poll</b></font></td>
                                                <td width="351" bgcolor="#007FFF" align="center"><font color="#FFFFFF" size="+1"><b>Date</b></font></td>
                                              </tr>
                                              <%while(rs.next())
	  {%>
                                              <tr>
