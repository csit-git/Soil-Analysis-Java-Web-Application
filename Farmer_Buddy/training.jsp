                              ...
                              <td><div style="width:933px">
                                  <table class="BasicTable" cellspacing="0" border="0" >
                                    <tbody>
                                      ...
                                      <td width="512" align="left" bgcolor="f8f8fa"  class="BlueMsgWriting">Knowledge is power. Proper education adds an edge to farming practices. Keeping in mind the necessity of imparting knowledge to the illitrate farmers who indulge themselves in unproductive and inefficient farming practices , Farmers buddy offers education through the uploaded training data. The agricultural officers can add any type of material on to this section and thus make it available for the Farmers and Agricultural Students.</td>
...
&nbsp;<a href="javascript:var i=DoSearch()"><img src="./Sample_files/SearchGoButton.gif" alt="Search" border="0" /></a> </td>
                                      ...
                                      <tr valign="top">
                                        <td width="202" height="370" valign="top"><table width="100&percnt;" cellpadding="0" cellspacing="0" border="0">
                                            <tbody>
                                              <tr valign="top">
                                        ...
                                        <td width="1">&nbsp;</td>
                                        <td colspan="2" align="left" valign="top"><table width="723" height="399" border="1" cellpadding="0" cellspacing="0">
                                          <tr>
                                            <td width="719"><%  String movie="";
...
%>
<b><font color="#4f9ece" size="+2"><%=type[j]%></font></b>
<hr>
<%
...
<UL>
<LI><%=name%>&nbsp;&nbsp;&nbsp;&nbsp;<a href="/Far/data/<%=type[j]%>/<%=name%>">Download</a>
<% if(type[j].equals("Video"))
   {
   %>
    <a href="play.jsp?name=<%=name%>">View</a></LI>
<%}%>
