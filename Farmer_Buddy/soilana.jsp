                                  ...
                                  <table class="BasicTable" cellspacing="0" border="0" >
                                    <tbody>
                                      ...
                                      <tr>
                                        ...
                                        <td width="511" align="left" bgcolor="f8f8fa"  class="BlueMsgWriting">An innovative thought by Farmers Buddy makes you the witness of the most appropriate solution for knowing the soil type, crops grown and fertilizers used in your region. This service makes use of geo coordinates of the location entered to map its soil type on the soil map of India.</td>
...
&nbsp;<a href="javascript:var i=DoSearch()"><img src="./Sample_files/SearchGoButton.gif" alt="Search" border="0" /></a>
                                      ...
                                      <tr valign="top">
                                        ...
                                        <form action="map.jsp" name="form1" method="post">
                                        <table width="71%">
                                        
                                      <tr><hr color="#FFFFFF" />
                                        <td width="231">Enter Your City or Location Name</td>
                                      ...
                                      <tr>
                                      <td>&nbsp;&nbsp;&nbsp;</td>
                                      <td align="left"><input type="submit" name="submit" id="submit" />                                        <div id="txt" class="Error404SubTitle" ></div></td>
                                      </tr>
                                  </table>
                                        <table width="511" border="1" cellspacing="0" cellpadding="0">
                                          <tr>
                                            <td align="center" width="507"><img src="FB_Files/map.jpg" alt="map" width="261" height="282" /></td>
                                          </tr>
                                        </table>
                                        </form></div>
                                  </td>
