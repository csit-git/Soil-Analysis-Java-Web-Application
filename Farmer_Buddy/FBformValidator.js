  ...
  function showandhideTable(ans)
  {
   ...
   if(out==2)
   {
	...
	document.getElementById("FarmerTable").style.display="block";
	document.getElementById("student").style.display="none";
	document.getElementById("officer").style.display="none";
	document.getElementById("StudentTable").style.display="none";
	document.getElementById("OfficerTable").style.display="none";
	...
	if(out==4)
   {
	...
	document.getElementById("FarmerTable").style.display="none";
	document.getElementById("StudentTable").style.display="none";
	document.getElementById("OfficerTable").style.display="block";
	}
}	

function securityQuestion(ans1)
{
 var out=ans1;
 if(out==1)
 {
 ...
 if(out==4)
 {
  document.getElementById("sectext").disabled=false;
 }
}
		...
		{
		 var out=str;
		 if(out!=document.getElementById("password").value)
		  {
		   document.getElementById("label1").innerHTML="password didnt match";
		  }
		  if(out==document.getElementById("password").value)
		  {
...
function chkName(name)
{
 ...
 xmlhttp.open("GET","chkname.jsp?name="+uname,true);
 xmlhttp.send(null);
}
