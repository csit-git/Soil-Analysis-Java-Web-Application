                                                    ...
                                                    <tr valign="top">
                                                      <td style="width: 280px;"><table height="222" cellpadding="0" cellspacing="0">
                                                          <tbody>
                                                            ...
                                                            <tr>
                                                              <td height="168" class="BasicFont"><iframe src="tpoll.jsp" height="222" width="100%" frameborder="0"></iframe>
                                                                 </td>
                                                            </tr>
                                                          </tbody>
                                                      </table></td>
                                                      ...
                                                      <td style="width: 280px;" valign="top"><table cellpadding="0" cellspacing="0">
                                                          <tbody>
                                                            ...
                                                            <tr>
                                                              <td class="BasicFont"><form id="form1" name="form1" action="chat12.jsp" method="post">
